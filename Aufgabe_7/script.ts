...
function playsound(){
    var mybeat:string[] = ["assets/kick.mp3", "assets/kick.mp3", "assets/hihat.mp3", "assets/F.mp3", "assets/F.mp3", "assets/F.mp3", "assets/A.mp3", "assets/F.mp3", "assets/kick.mp3", "assets/kick.mp3", "assets/hihat.mp3", "assets/laugh-1.mp3"];
    var index:number = 0;
