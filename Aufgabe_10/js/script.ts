...
function drawListToDOM(): void {
    ...
    for (let index: number = 0; index < todolist.text.length; index++) {
         ...
         */
        let todo: HTMLElement = document.createElement("div"); // noch kein Div Container im DOM. Muss erst gesagt werden
        todo.classList.add("todo"); //Div wird Klasse zugewiesen
...
// was macht DrawListtoDom : die bereits im Array stehende ToDos Laden

function updateCounter(): void {
    var check: number = 0;
    var uncheck: number = 0;
    for (let index: number = 0; index < todolist.status.length; index++) {
...
// Was macht addToDo : fügt den Input des Users hinzu
